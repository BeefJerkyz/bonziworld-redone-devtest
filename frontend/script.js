...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziGlare", src: "./img/bonzi/glare.png" },
        { id: "bonziGold", src: "./img/bonzi/gold.png" },
        { id: "bonziDevil", src: "./img/bonzi/devil.png" },
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "cyan", "blue", "brown", "green", "purple", "red", "pink", "yellow", "gold", "glare", "devil", "gray", "pope"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziYellow", "bonziGlare", "bonziGold", "bonziDevil", "bonziCyan", "bonziGray", "topjej"];
